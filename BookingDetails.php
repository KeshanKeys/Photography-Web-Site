...
if ($_SERVER["REQUEST_METHOD"] === "POST") { 
    ...
    $sql = "INSERT INTO bookingdetails ( Name, Email, Contact,Date,Event) VALUES ('$name', '$email','$contact','$date','$event')";
...
try {
    ...
    // Content
    $mail->isHTML(true);
    $mail->Subject = 'Your Booking Recevied';
    $mail->Body = "We Recived your Booking .We will Contact you within 1 day.Thank You-Malcolm Photography";
